...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppMapsearchMapsearchComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_signin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./class/signin */
    ...
    var _service_apiservice_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./service/apiservice.service */
    "./src/app/service/apiservice.service.ts");
    /* harmony import */


    var ng4_social_login__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ng4-social-login */
    "./node_modules/ng4-social-login/ng4-social-login.umd.js");
    /* harmony import */


    var ng4_social_login__WEBPACK_IMPORTED_MODULE_6___default =
    /*#__PURE__*/
    __webpack_require__.n(ng4_social_login__WEBPACK_IMPORTED_MODULE_6__); // import { AuthService, FacebookLoginProvider, SocialUser } from 'angularx-social-login';
    ...
    function () {
      function AppComponent(socialAuthService, api, router, modalService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function FBSignin() {
          ...
          this.socialAuthService.signIn(ng4_social_login__WEBPACK_IMPORTED_MODULE_6__["FacebookLoginProvider"].PROVIDER_ID).then(function (userData) {
            _this2.user = userData;
            _this2.username = userData.name;
            console.log('yeahhhh', _this2.username);
          });
        }
      }, {
        ...
        key: "signInWithFB",
        value: function signInWithFB() {// this.authService.signIn(FacebookLoginProvider.PROVIDER_ID);
        }
      }, {
        key: "onSubmit",
        value: function onSubmit() {
          ...
          this.api.signin(this.signInModel).subscribe(function (data) {
        ...
        value: function signOut() {
          ...
          this.apikey = 'null';
          this.router.navigate(['/']); // this.authService.signOut();
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {
          var key = localStorage.getItem('apikey'); // console.log('just enteredd againnn', key);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _mapsearch_mapsearch_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./mapsearch/mapsearch.component */
    ...
    var _signin_signin_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    ...
    var _sell_sell_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./sell/sell.component */
    "./src/app/sell/sell.component.ts");
    /* harmony import */


    var _logout_logout_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    ...
    var _mypost_mypost_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./mypost/mypost.component */
    "./src/app/mypost/mypost.component.ts");
    /* harmony import */


    var ng4_social_login__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ng4-social-login */
    "./node_modules/ng4-social-login/ng4-social-login.umd.js");
    /* harmony import */


    var ng4_social_login__WEBPACK_IMPORTED_MODULE_24___default =
    /*#__PURE__*/
    __webpack_require__.n(ng4_social_login__WEBPACK_IMPORTED_MODULE_24__); // import { SocialLoginModule, AuthServiceConfig, FacebookLoginProvider } from 'angularx-social-login';


    var CONFIG = new ng4_social_login__WEBPACK_IMPORTED_MODULE_24__["AuthServiceConfig"]([// {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _index_index_component__WEBPACK_IMPORTED_MODULE_5__["IndexComponent"], _filter_filter_component__WEBPACK_IMPORTED_MODULE_9__["FilterComponent"], _detail_detail_component__WEBPACK_IMPORTED_MODULE_12__["DetailComponent"], _mapsearch_mapsearch_component__WEBPACK_IMPORTED_MODULE_14__["MapsearchComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_15__["LoginComponent"], _signin_signin_component__WEBPACK_IMPORTED_MODULE_17__["SigninComponent"], _signup_signup_component__WEBPACK_IMPORTED_MODULE_18__["SignupComponent"], _sell_sell_component__WEBPACK_IMPORTED_MODULE_19__["SellComponent"], _logout_logout_component__WEBPACK_IMPORTED_MODULE_20__["LogoutComponent"], _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_22__["NavbarComponent"], _mypost_mypost_component__WEBPACK_IMPORTED_MODULE_23__["MypostComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot(appRoutes, {
        enableTracing: true
      } // <-- debugging purposes only #AIzaSyBfZ86mdGX5E7o4PGSB7ct22axSb_JzVTY
      ), _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_10__["NgMultiSelectDropDownModule"].forRoot(), ngx_ui_loader__WEBPACK_IMPORTED_MODULE_11__["NgxUiLoaderModule"], ngx_ui_loader__WEBPACK_IMPORTED_MODULE_11__["NgxUiLoaderRouterModule"], ngx_ui_loader__WEBPACK_IMPORTED_MODULE_11__["NgxUiLoaderHttpModule"], // NgxUiLoaderRouterModule.forRoot({ showForeground: true }),
      ngx_ui_loader__WEBPACK_IMPORTED_MODULE_11__["NgxUiLoaderHttpModule"].forRoot({
        showForeground: true
      ...
      ngx_pagination__WEBPACK_IMPORTED_MODULE_16__["NgxPaginationModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_21__["NgbModule"], ng4_social_login__WEBPACK_IMPORTED_MODULE_24__["SocialLoginModule"]],
      providers: [{
  ...
  /***/
  function srcAppClassSellTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Sell", function () {
      return Sell;
    });
    /* harmony import */
  ...
  /***/
  function srcAppClassSigninTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppClassSignupTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Signup = function Signup(username, email, password) {
  ...
  /***/
  function srcAppClassSocialloginTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Sociallogin = function Sociallogin(access_token) {
  ...
  /***/
  function srcAppClassfunctionTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Classfunction", function () {
    ...
    var Classfunction = function Classfunction(name, pricemin, pricemax, bedmin, bedmax, propertytype) {
  ...
  function srcAppDetailDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_apiservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../service/apiservice.service */
    "./src/app/service/apiservice.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function DetailComponent(location, api) {
        var _this4 = this;
        ...
        this.getPosterDetail = function (id) {
          _this4.api.getposterDetails(id).subscribe(function (data) {
            // console.log(this.countrydetaillsapi, 'comedylist');
            _this4.posterdetails = data.results;
            _this4.longitude = Number(data.results[0].longitude);
            _this4.latitude = Number(data.results[0].latitude);
  ...
  function srcAppFilterFilterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _classfunction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../classfunction */
    "./src/app/classfunction.ts");
    ...
    /*#__PURE__*/
    function () {
      function FilterComponent(actRoute, api, router) {
        var _this5 = this;
        ...
        this.dropdownList = [];
        this.selectedItems = [];
        this.propertytype = []; // this is for  ng-multiselect-dropdown;
        ...
        this.getFilterDetail = function () {
          // console.log('testingggg');
          _this5.api.getfilterDetails(_this5.searchparam).subscribe(function (data) {
            // console.log(this.countrydetaillsapi, 'comedylist');
            _this5.filterdetails = data.results;
            _this5.filterdetails1 = data.results;
            _this5.previous = data.previous;
            _this5.next = data.next;
            _this5.count = data.count; // this.filterdetails, this.previous, this.next,

            console.log(_this5.filterdetails.length, 'datttaacountt');
          }, function (error) {
            console.log(error);
          });
        };
        ...
        this.mapSearch = function () {
          ...
          _this5.router.navigate(['/mapsearch']);

          console.log('ended');
        };

        this.getCountryDetail = function () {
          console.log('testingggg');

          _this5.api.getcountryDetails().subscribe(function (data) {
            // console.log(this.countrydetaillsapi, 'comedylist');
            _this5.countrydetaillsapi = data;
            _this5.testlist = data;
            console.log(_this5.countrydetaillsapi, 'datttaa');
          }, function (error) {
            console.log(error);
          });
        };
      ...
      _createClass(FilterComponent, [{
        ...
        value: function onItemSelect(item) {
          console.log(item, this.propertytype); // this.propertytype = item;
        ...
        key: "pricemin",
        value: function pricemin() {
          var pricemin = this.searchModel.pricemin;
          pricemin = pricemin.replace(',', '');
          pricemin = pricemin.replace('$', '');
          pricemin = pricemin.replace(' ', '');

          if (pricemin === 'Any') {
            var newlist = this.filterdetails.filter(function (el) {
              return el.Price >= 0;
            });
            ...
            // filterdetails
            var _newlist = this.filterdetails.filter(function (el) {
              return el.Price >= pricemin;
            });

            this.filterdetails1 = _newlist;
            console.log(pricemin, 'yeajhh');
          }
        }
      }, {
        key: "pricemax",
        value: function pricemax() {
          var pricemax = this.searchModel.pricemax;
          ...
          if (pricemax === 'Any') {
            var newlist = this.filterdetails.filter(function (el) {
              return el.Price <= 10000000000000000;
            });
            this.filterdetails1 = newlist;
            console.log(newlist, this.filterdetails);
            ...
            // filterdetails
            var _newlist2 = this.filterdetails.filter(function (el) {
              return el.Price <= pricemax;
            });

            this.filterdetails1 = _newlist2;
            console.log(pricemax, 'yeajhh');
          }
        }
      }, {
        key: "bedmin",
        value: function bedmin() {
          var bedmin = this.searchModel.bedmin;

          if (bedmin === 'Any') {
            var newlist = this.filterdetails.filter(function (el) {
              return el.Bedrooms >= 10000000000000000;
            });
            this.filterdetails1 = newlist;
            console.log(newlist, this.filterdetails);
            console.log(bedmin, 'yeajhh');
          } else if (bedmin === 'Studio') {
            var _newlist3 = this.filterdetails.filter(function (el) {
              return el.Bedrooms >= 0;
            });

            this.filterdetails1 = _newlist3;
            console.log(_newlist3, this.filterdetails);
            console.log(bedmin, 'yeajhh');
          } else {
            // filterdetails
            var _newlist4 = this.filterdetails.filter(function (el) {
              return el.Bedrooms >= bedmin;
            });

            this.filterdetails1 = _newlist4;
            console.log(bedmin, 'yeajhh');
          }
        }
      }, {
        key: "bedmax",
        value: function bedmax() {
          var bedmax = this.searchModel.bedmax;
          ...
          if (bedmax === 'Any') {
            ...
            var _newlist5 = this.filterdetails.filter(function (el) {
              return el.Bedrooms <= 0;
            });

            this.filterdetails1 = _newlist5;
            console.log(_newlist5, this.filterdetails);
            console.log(bedmax, 'yeajhh');
          } else {
            // filterdetails
            var _newlist6 = this.filterdetails.filter(function (el) {
              return el.Bedrooms <= bedmax;
            });

            this.filterdetails1 = _newlist6;
            console.log(bedmax, 'yeajhh');
          }
        } // bathrooms() {
  ...
  function srcAppIndexIndexComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _classfunction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../classfunction */
    "./src/app/classfunction.ts");
    /* harmony import */
    ...
    function () {
      function IndexComponent(api, router) {
        ...
        this.hideDiv = function () {
          // this.dis = false;
          console.log(_this6.searchModel.name, 'yeahhh');
        };

        this.getDetails = function (data) {
          var value = _this6.searchModel.name;
          console.log(data.state, data.suburb, _this6.searchModel.name);
          _this6.dis = false; // tslint:disable-next-line: no-shadowed-variable
          ...
          if (_this6.searchModel.name === undefined) {
            _this6.inputdata = _this6.inputdata + data.suburb + ' ' + '-' + data.state + ';';
            _this6.searchModel.name = _this6.inputdata;
          } else {
            _this6.inputdata = _this6.inputdata + data.suburb + ' ' + '-' + data.state + ';';
            _this6.searchModel.name = _this6.inputdata;
          }
        ...
        this.filterCountryDetails = function () {
          // if (this.searchModel.name) {
          // }
          _this6.dis = true;

          var input = _this6.searchModel.name.lastIndexOf(';');

          var lastinput = _this6.searchModel.name.slice(-1);

          console.log(lastinput); // tslint:disable-next-line: triple-equals

          if (lastinput === ';') {
            _this6.inputdata = _this6.searchModel.name;
            _this6.testlist = [];
          }
          ...
          if (input !== -1) {
            ...
            var newvalue = _this6.searchModel.name.toUpperCase().substring(input + 1).trim(); // console.log('yeayyh', input, newvalue);


            var value = _this6.searchModel.name.toUpperCase();

            console.log(newvalue); // const inputvalue = this.searchModel.name.toUpperCase();
            // const newvalue = this.searchModel.name.toUpperCase().substring(input + 1).trim();

            if (newvalue.includes('-')) {
              console.log('yeah it includes');
              var lastin = newvalue.lastIndexOf('-');
              var newvalue1 = newvalue.substring(lastin + 1).trim();

              var newlist = _this6.testlist.filter(function (el) {
                return el.state.includes(newvalue1);
              });

              console.log('contains', newvalue1, newlist, _this6.testlist);
            } else {
              console.log('nahh it done');

              var test1 = _this6.countrydetaillsapi.filter(function (el) {
                return el.suburb.includes(newvalue);
              });

              _this6.testlist = test1;
              console.log(_this6.testlist, newvalue, 'valueee'); // console.log('ended');
          ...
          if (_this6.searchModel.name.toUpperCase() === '') {
            _this6.countrydata = _this6.realdata;
          }

          if (input === -1) {
            console.log('started22');

            var inputvalue = _this6.searchModel.name.toUpperCase();

            var _newvalue = _this6.searchModel.name.toUpperCase().substring(input + 1).trim();

            if (_this6.searchModel.name.toUpperCase().includes('-')) {
              var _lastin = _this6.searchModel.name.toUpperCase().lastIndexOf('-');

              var _newvalue2 = _this6.searchModel.name.toUpperCase().substring(_lastin + 1).trim();

              var _newlist7 = _this6.testlist.filter(function (el) {
                return el.state.includes(_newvalue2);
              });

              console.log('contains', _newvalue2, _newlist7, _this6.testlist);
            } else {
              var _test = _this6.countrydetaillsapi.filter(function (el) {
                return el.suburb.includes(inputvalue);
              });

              _this6.testlist = _test;
              console.log(_this6.testlist, inputvalue, 'valueee');
              console.log('ended');
        ...
        this.getCountryDetail = function () {
          // console.log('testingggg');
          _this6.api.getcountryDetails().subscribe(function (data) {
            // console.log(this.countrydetaillsapi, 'comedylist');
            var unique = _this6.getUnique(data, 'suburb');

            _this6.countrydetaillsapi = data;
            _this6.testlist = data;
            console.log(_this6.countrydetaillsapi, 'datttaa');
        ...
        this.submitForm = function () {
          _this6.searchModel.propertytype = _this6.propertytype;
          console.log('search model', _this6.searchModel.propertytype);
          var searchparams = {
            name: _this6.searchModel.name.trim(),
            bedmin: _this6.searchModel.bedmin,
            bedmax: _this6.searchModel.bedmax,
            pricemin: _this6.searchModel.pricemin,
            pricemax: _this6.searchModel.pricemax,
            propertytype: _this6.searchModel.propertytype
          ...
          _this6.router.navigate(['/filter', searchparams]);
        };
      ...
      _createClass(IndexComponent, [{
        key: "getUnique",
        value: function getUnique(arr, comp) {
        ...
        key: "ngOnInit",
        value: function ngOnInit() {
          var key = localStorage.getItem('apikey'); // console.log('just enteredd', key);
  ...
  /***/
  function srcAppMapsearchMapsearchComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMapsearchMapsearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _service_apiservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../service/apiservice.service */
    "./src/app/service/apiservice.service.ts");

    var MapsearchComponent =
    /*#__PURE__*/
    function () {
      function MapsearchComponent(api) {
        var _this7 = this;
        ...
        this.getmapSearch = function () {
          var searchurl = localStorage.getItem('searchparams');
          console.log(localStorage.getItem('searchparams'), 'this is it ooh');
          console.log('clicked');

          _this7.api.getmapSearch(searchurl).subscribe(function (data) {
            _this7.details = data.results;
            _this7.latitude = data.results[0].latitude;
            _this7.longitude = data.results[0].longitude;
            console.log(data.results, _this7.latitude, _this7.longitude, 'datttaacounttaaaaa');
          }, function (error) {
            console.log(error);
          });
        };
    ...
    MapsearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./mapsearch.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/mapsearch/mapsearch.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./mapsearch.component.css */
      "./src/app/mapsearch/mapsearch.component.css")).default]
    })], MapsearchComponent);
    /***/
  },
  ...
  function srcAppMypostMypostComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MypostComponent, [{
        ...
        value: function getMyPost() {
          ...
          this.api.mypost().subscribe(function (data) {
            _this8.details = data.results;
            console.log(_this8.details, 'original');
          }, function (error) {
            console.log(error);
          });
        }
    ...
    MypostComponent.ctorParameters = function () {
      return [{
        type: _service_apiservice_service__WEBPACK_IMPORTED_MODULE_2__["ApiserviceService"]
      }];
    };
  ...
  function srcAppNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_signin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../class/signin */
    "./src/app/class/signin.ts");
    /* harmony import */


    var _class_signup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../class/signup */
    "./src/app/class/signup.ts");
    /* harmony import */


    var _class_sociallogin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./../class/sociallogin */
    "./src/app/class/sociallogin.ts");
    /* harmony import */


    var ng4_social_login__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ng4-social-login */
    "./node_modules/ng4-social-login/ng4-social-login.umd.js");
    /* harmony import */


    var ng4_social_login__WEBPACK_IMPORTED_MODULE_8___default =
    /*#__PURE__*/
    __webpack_require__.n(ng4_social_login__WEBPACK_IMPORTED_MODULE_8__);

    var NavbarComponent =
    /*#__PURE__*/
    function () {
      function NavbarComponent(socialAuthService, api, router, modalService) {
        var _this9 = this;
        ...
        this.registerUser = function () {
          console.log(_this9.signUpModel);

          _this9.api.signup(_this9.signUpModel).subscribe(function (data) {
            console.log('Success!'), _this9.check = 'signin';
            _this9.signUpModel = new _class_signup__WEBPACK_IMPORTED_MODULE_6__["Signup"]('', '', ''); //  this.router.navigate(['/signin'])),
          }, // tslint:disable-next-line: no-string-literal
          function (error) {
            return console.log('oops', error.error);
          } // erro => console.error('Error', error)
      ...
      _createClass(NavbarComponent, [{
        ...
        value: function FBSignin() {
          ...
          this.socialAuthService.signIn(ng4_social_login__WEBPACK_IMPORTED_MODULE_8__["FacebookLoginProvider"].PROVIDER_ID).then(function (userData) {
            _this10.SocialloginModel = new _class_sociallogin__WEBPACK_IMPORTED_MODULE_7__["Sociallogin"](userData.token);

            _this10.api.socialSignIn(_this10.SocialloginModel).subscribe(function (data) {
              // set the apikey and username in the local storage
              localStorage.setItem('apikey', data.key);
              localStorage.setItem('username', userData.name); // set the apove apokey and myuser value for auto update

              _this10.apikey = data.key;
              _this10.myuser = userData.name;
        ...
        key: "open",
        value: function open(content, check) {
          var _this11 = this;
        ...
        value: function loginUser() {
          ...
          this.api.signin(this.signInModel).subscribe(function (data) {
            localStorage.setItem('apikey', data.key);
            var key = localStorage.getItem('apikey');
            _this12.apikey = data.key;

            _this12.modalService.dismissAll();

            _this12.signInModel = new _class_signin__WEBPACK_IMPORTED_MODULE_5__["Signin"]('', '');
        ...
        value: function ngOnInit() {
          var key = localStorage.getItem('apikey');
          var username = localStorage.getItem('username'); // console.log('just enteredd againnn', key);,
  ...
  function srcAppSellSellComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_sell__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../class/sell */
    "./src/app/class/sell.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function SellComponent(api, router, http) {
        var _this13 = this;
        ...
        this.getCountryDetail = function (state) {
          // console.log('testingggg');
          _this13.api.getcountryDetails2(state).subscribe(function (data) {
            // console.log(this.countrydetaillsapi, 'comedylist');
            var unique = _this13.getUnique(data, 'postcode');

            _this13.countrydetaillsapi = _this13.getUnique(unique, 'suburb'); // this.testlist = data;

            console.log(_this13.countrydetaillsapi, 'datttaa');
      ...
      _createClass(SellComponent, [{
        ...
        key: "onFileSelected",
        value: function onFileSelected(event, formname) {
        ...
        value: function onSubmit() {
          ...
          this.mykey = 'Token ' + localStorage.getItem('apikey'); // console.log(this.sellModel, 'submitted', form);

          for (var _i = 0, _Object$entries = Object.entries(this.sellModel); _i < _Object$entries.length; _i++) {
            var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
                key = _Object$entries$_i[0],
                value = _Object$entries$_i[1];

            if (key.includes('image') || key.includes('plan') || key.includes('image1') || key.includes('image2') || key.includes('image3') || key.includes('image4') || key.includes('image5') || key.includes('image6') || key.includes('image7') || key.includes('image8') || key.includes('image9') || key.includes('image10') || key.includes('image11') || key.includes('image12') || key.includes('image3') || key.includes('image14') || key.includes('image15') || key.includes('image16') || key.includes('image17') || key.includes('image18')) {//   if (value !== null || value !== '') {
          ...
          this.http.post('https://anandrathi.pythonanywhere.com/indexapi/postercreate/', this.form, {
            ...
            _this14.router.navigate(['/mypost']);
          }, // tslint:disable-next-line: no-string-literal
          function (error) {
            return console.log('oops', error.error);
          } // erro => console.error('Error', error)
  ...
  function srcAppServiceApiserviceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_sell__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../class/sell */
    "./src/app/class/sell.ts");
    ...
    function () {
      function ApiserviceService(http) {
        ...
        this.posterIdUser = '';
        this.countryDetailsUrl = 'https://anandrathi.pythonanywhere.com/adminapi/countrylistapi/'; // filterUrl = 'http://anandrathi.pythonanywhere.com/indexapi/posterlistapi/';
      ...
      _createClass(ApiserviceService, [{
        ...
        key: "socialSignIn",
        value: function socialSignIn(socialmodel) {
        ...
        key: "sell",
        value: function sell(_sell) {
          var key = localStorage.getItem('apikey');
          this.apikey = key;
          console.log('keyy', _class_sell__WEBPACK_IMPORTED_MODULE_3__["Sell"]);
          return this.http.post(this.sellUrl, _sell, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
              Authorization: 'Token b9c43a76d8e68e995decb6f7e80546cf475fe844'
            })
          });
        }
      }, {
        ...
        value: function getcountryDetails() {
          return this.http.get(this.countryDetailsUrl, {
            headers: this.httpHeaders
          });
        } // this function is used to filter state to post

      }, {
        key: "getcountryDetails2",
        value: function getcountryDetails2(state) {
          return this.http.get('https://anandrathi.pythonanywhere.com/adminapi/countrylistapi/?state=' + state, {
            headers: this.httpHeaders
          });
        }
      }, {
        key: "getfilterDetails",
        value: function getfilterDetails(datas) {
          var name = datas.name.trim().replace(';', '_').replace(' ', '');
        ...
        key: "getposterDetails",
        value: function getposterDetails(id) {
        ...
        key: "getmapSearch",
        value: function getmapSearch(url) {
  ...
  function srcAppSigninSigninComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_signin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../class/signin */
    "./src/app/class/signin.ts");
    ...
    function () {
      ...
      _createClass(SigninComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.api.signin(this.signInModel).subscribe(function (data) {
            localStorage.setItem('apikey', data.key);
            var key = localStorage.getItem('apikey'); // this.apikey = data.key;
  ...
  function srcAppSignupSignupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _class_signup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../class/signup */
    "./src/app/class/signup.ts");
    /* harmony import */
    ...
    function () {
      function SignupComponent(api, router) {
        ...
        this.onSubmit = function () {
          console.log(_this16.signUpModel);

          _this16.api.signup(_this16.signUpModel).subscribe(function (data) {
            return console.log('Success!', _this16.router.navigate(['/signin']));
          }, // tslint:disable-next-line: no-string-literal
          function (error) {
            return console.log('oops', error.error);
          } // erro => console.error('Error', error)
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\BUDESCODE\Documents\coding\projects\real estate\Angular\project\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
